...
var KakaoStrategy = /** @class */ (function (_super) {
    ...
    KakaoStrategy.prototype.validate = function (_accessToken, _refreshToken, profile, done) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.cacheManager.set(tokenKeyCode, tokenPayload, { ttl: 60 })];
                    case 2:
                        _a.sent();
